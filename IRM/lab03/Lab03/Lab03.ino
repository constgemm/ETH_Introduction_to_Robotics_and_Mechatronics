...
// Waveform table of wave samples taken from - https://www.arduino.cc/en/Tutorial/DueSimpleWaveformGenerator 
...
void loop() {
  ...
  while(1)  
  {
  	analogWrite(DAC1, waveformsTable[0][i]);  // Output the analog sine waveform on DAC1 pin  
